...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e1pdmerge_datasystem_ipc_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    1E1PD共卡, 单机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e2pd_datasystem_tcp_ipv4_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    1E2PD, 单机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy3e5pd_datasystem_tcp_ipv6_001(model: str, tp_size: int, dataset: str, request_rate: float, router: str):
    '''
    3E5PD, 单机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e1p1d_datasystem_ipc_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    P1E1P1D, 单机部署
    前缀缓存： 开启
    数据集：模拟ZJ、image4
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy2e3p3d_datasystem_tcp_ipv6_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    P2E3P3D, 单机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e1p1d_datasystem_tcp_ipv4_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    P1E1P-1D, 单机部署
    前缀缓存： 开启
    数据集：模拟ZJ、image4
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e1p1d_datasystem_tcp_ipv6_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    P1E1P-1D, 单机部署
    前缀缓存： 开启
    数据集：模拟ZJ、image4
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy_1e_2pd_cross_datasystem_tcp_ipv4_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    1E2PD, 跨机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("enable_prefix", PREFIX_CACHE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy_1e_2pd_cross_datasystem_tcp_ipv4_002(model: str, tp_size: int, dataset: str, request_rate: float,
                                                          enable_prefix: bool):
    '''
    1E2PD, 跨机部署
    前缀缓存： 开启/关闭
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e_2pd_cross_datasystem_tcp_ipv6_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    P1E——2PD, 跨机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e1p_1d_cross_datasystem_tcp_ipv6_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    P1E1P-1D, 跨机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e_1p_1d_cross_datasystem_tcp_ipv4_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    P1E-1P-1D, 跨机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("router", ROUTER)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy2e3p_3d_cross_datasystem_tcp_ipv6_001(model: str, tp_size: int, dataset: str, request_rate: float, router: str):
    '''
    P2E3P-3D, 跨机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("tp_size", TENSOR_PARALLELS)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e2pd_datasystem_ipc_acc_001(model: str, tp_size: int, dataset: str):
    '''
    1E2PD, 单机部署
    前缀缓存： 开启
    数据集：textvqa_subset
...
@pytest.mark.parametrize("tp_size", TENSOR_PARALLELS)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy_1e_2pd_cross_datasystem_tcp_ipv4_acc_001(model: str, tp_size: int, dataset: str):
    '''
    P-1E-2PD, 跨机部署
    前缀缓存： 开启
    数据集：textvqa_subset
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e_2pd_cross_datasystem_tcp_ipv6_stability_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    P1E——2PD, 跨机部署
    前缀缓存： 开启
    数据集：模拟ZJ
...
@pytest.mark.parametrize("request_rate", REQUEST_RATE)
@pytest.mark.parametrize("dataset", DATASET_NAME)
async def test_proxy1e_1p_1d_cross_datasystem_tcp_ipv4_stability_001(model: str, tp_size: int, dataset: str, request_rate: float):
    '''
    P1E-1P-1D, 跨机部署
    前缀缓存： 开启
    数据集：模拟ZJ
